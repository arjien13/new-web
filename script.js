...
// BIO SECTION
function showBio() {
  setDisplay('.intro, .footer, .social-media-icons, #resume-section, .my-image, .Portfolio-Section, .folder-container, .pfolder-wrapper, .vfolder-wrapper, .skills-section-container', 'none');
  setDisplay('.bio-section, .bio-paragraph, .bio-photo, .profession', 'block');
}

// RESUME SECTION
function showResume() {
  setDisplay('.intro, .footer, .social-media-icons, .bio-photo, .folder-container, .profession, .my-image, .bio-paragraph, .bio-section, .Portfolio-Section, .pfolder-wrapper, .vfolder-wrapper, .skills-section-container', 'none');
...
function showpfolder() {
  setDisplay('.intro, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .bio-section, #resume-section, .Portfolio-Section, .my-image, .skills-section-container, .vfolder-wrapper, .folder-container', 'none');
  setDisplay('.pfolder-wrapper', 'block'); 
}

// Videofolder SECTION
function showvfolder() {
  setDisplay('.intro, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .bio-section, #resume-section, .Portfolio-Section, .my-image, .pfolder-wrapper, .skills-section-container, .folder-container', 'none');
