...
// BIO SECTION
function showBio() {
  setDisplay('.intro, #message, .centered-inspector, .hamburger, .jarviz-container, .footer, .social-media-icons, .my-image, .Portfolio-Section, .grid-wrapper1, .political-wrapper, .pfolder-wrapper, .vfolder-wrapper, .skills-section-container', 'none');
...
function showPortfolio() {
  setDisplay('.intro, #message, .hamburger, .jarviz-container, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .bio-section, .pfolder-wrapper, .vfolder-wrapper, #resume-section, .centered-inspector', 'none');
...
function showPolitical() {
  setDisplay('.intro, #message, .centered-inspector, .hamburger, .jarviz-container, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .bio-section, .Portfolio-Section, .my-image, .vfolder-wrapper, .pfolder-wrapper, .skills-section-container, .grid-wrapper1', 'none');
...
window.addEventListener('load', () => {
  ...
  if (localStorage.getItem('showPortfolio') === 'true') {
    showPortfolio();
    document.querySelector('.centered-inspector').style.display = 'none';
