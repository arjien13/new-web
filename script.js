...
// BIO SECTION
function showBio() {
  setDisplay('.intro, .jarviz-container, .footer, .social-media-icons, .my-image, .Portfolio-Section, .grid-wrapper1, .political-wrapper, .pfolder-wrapper, .vfolder-wrapper, .skills-section-container', 'none');
...
function showpfolder() {
  setDisplay('.intro, .jarviz-container, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .political-wrapper, .bio-section, .Portfolio-Section, .my-image, .skills-section-container, .vfolder-wrapper, .grid-wrapper1', 'none');
...
function showPolitical() {
  setDisplay('.intro, .jarviz-container, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .bio-section, .Portfolio-Section, .my-image, .vfolder-wrapper, .pfolder-wrapper, .skills-section-container, .grid-wrapper1', 'none');
