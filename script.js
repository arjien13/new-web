...
// BIO SECTION
function showBio() {
  setDisplay('.intro, .footer, .social-media-icons, .my-image, .Portfolio-Section, .folder-container, .political-wrapper, .pfolder-wrapper, .vfolder-wrapper, .skills-section-container', 'none');
...
function showpfolder() {
  setDisplay('.intro, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .political-wrapper, .bio-section, .Portfolio-Section, .my-image, .skills-section-container, .vfolder-wrapper, .folder-container', 'none');
  setDisplay('.pfolder-wrapper', 'block'); 
}

// Videofolder SECTION
function showvfolder() {
  setDisplay('.intro, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .political-wrapper, .bio-section, .Portfolio-Section, .my-image, .pfolder-wrapper, .skills-section-container, .folder-container', 'none');
  setDisplay('.vfolder-wrapper', 'block'); 
}

// Blog Political SECTION
function showPolitical() {
  setDisplay('.intro, .footer, .social-media-icons, .bio-photo, .profession, .bio-paragraph, .bio-section, .Portfolio-Section, .my-image, .vfolder-wrapper, .pfolder-wrapper, .skills-section-container, .folder-container', 'none');
